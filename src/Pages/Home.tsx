...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid grid-cols-3 gap-8 mt-16 max-w-3xl mx-auto">
              <div className="text-center">
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-purple-400 mb-2">500+</div>
                <div className="text-gray-400 text-xs sm:text-sm md:text-base">Projects Completed</div>
              </div>
              <div className="text-center">
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-purple-400 mb-2">15+</div>
                <div className="text-gray-400 text-xs sm:text-sm md:text-base">Years Experience</div>
              </div>
              <div className="text-center">
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-purple-400 mb-2">50+</div>
                <div className="text-gray-400 text-xs sm:text-sm md:text-base">Awards Won</div>
              </div>
            </div>
      ...
      {/*Intro Section */}
      <section className="intro-section py-0 sm:py-0 px-0 bg-gray-900 opacity-0 animate-fadeIn overflow-visible">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700 hover:border-purple-500 transition-all duration-300 group">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">Wedding Films</h3>
              <p className="text-gray-400 text-sm sm:text-base">Capturing the magic of your special day with cinematic elegance and emotional depth.</p>
            </div>
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700 hover:border-purple-500 transition-all duration-300 group">
              <div className="w-16 h-16 bg-purple-600/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-purple-600/30 transition-colors">
                <Play className="text-purple-400" size={32} />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">Commercial Videos</h3>
              <p className="text-gray-400 text-sm sm:text-base">Elevate your brand with compelling video content that drives engagement and results.</p>
            </div>
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700 hover:border-purple-500 transition-all duration-300 group">
              <div className="w-16 h-16 bg-purple-600/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-purple-600/30 transition-colors">
                <Award className="text-purple-400" size={32} />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">Documentary</h3>
              <p className="text-gray-400 text-sm sm:text-base">Tell powerful stories that inspire, educate, and leave a lasting impact on viewers.</p>
            </div>
          </div>
        </div>
      </section>
